...
const stripe = require('stripe')('sk_test_51HntskF2L8fuCGTnCAqrp0jNNyF3qjKv7TzIBY2dLpDdKFQ1KkZJZBBP7CdMZTq7vvPUoI5iDQ5UNEQjFA5P6HZb00iUeGGMNN');
    ...
    .then(user => {
      ...
      return stripe.checkout.sessions.create({
        ...
        line_items: products.map(p => {
         ...
         success_url: req.protocol + '://' + req.get('host')  + '/checkout/success', // => http://localhost:5005
         cancel_url:req.protocol + '://' + req.get('host')  + '/checkout/cancel'
      }); 
    })
    .then(session => {
      res.render('pages/shopStuff/shop/checkout', {
        path: '/shop/checkout',
        pageTitle: 'Checkout',
        products: products,
        totalSum: total,
