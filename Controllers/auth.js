...
exports.postSignup = (req, res, next) => {
  ...
  if (!errors.isEmpty()) {
    ...
    return res.status(422).render('pages/shopStuff/auth/signup', {
      path: '/signup',
      pageTitle: 'Signup',
  ...
  .then(userDoc => {
    if (userDoc) {
      req.flash('error', 'E-mail is already in use, pick a different one.');
...
exports.getReset = (req, res, next) => {
  ...
  res.render('pages/shopStuff/auth/reset', {
    path: '/reset',
...
exports.getNewPassword = (req, res, next) => {
  ...
  res.render('pages/shopStuff/auth/new-password', {
    path: '/new-password',
